...
def reformated_orderbook(prices, c_direction):
    """
    Reformat order book data for easier depth calculation.

    Parameters:
        prices (dict): Order book data from exchange API.
        c_direction (str): Direction of trade, either "base_to_quote" or "quote_to_base".

    Returns:
        list: List of lists, where each sublist is [adj_price, adj_quantity].
    """
    price_list_main = []
...
def get_depth_from_orderbook(surface_arb):
    """
    Function to get the depth from the order book given a surface arbitrage opportunity.

    Parameters
    ----------
    surface_arb : dict
        A dictionary containing the surface arbitrage opportunity. This should include the following keys:
            - swap_1: str
                The first swap coin
            - contract_1: str
                The first contract
            ...
            - contract_3: str
                The third contract
            - direction_trade_1: str
                The direction of the first trade
            - direction_trade_2: str
                The direction of the second trade
            - direction_trade_3: str
                The direction of the third trade

    Returns
    -------
    dict
        A dictionary containing the profit loss and real rate percent of the surface arbitrage opportunity.
    """
